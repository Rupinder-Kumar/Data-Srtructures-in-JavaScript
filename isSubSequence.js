//PS:  write a function which takes in two strings and checks whether the 
// characters in the first string form a subsequence of the characters in 
...
// example: isSubsequence('abc', 'acd') -> false (order is different)
